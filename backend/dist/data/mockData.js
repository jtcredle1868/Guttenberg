...
exports.disbursements = exports.versionHistory = exports.activityEvents = exports.organization = exports.formatJobs = exports.arcCampaigns = exports.salesRecords = exports.distributionRecords = exports.formats = exports.titles = exports.authors = void 0;
// ─── Authors ────────────────────────────────────────────────────────────────
exports.authors = [
    {
        id: 'author-001',
...
exports.titles = [
    ...
    },
    {
        ...
        description: 'Humanity\'s last colony ship discovers an alien signal buried in a dying star—but decoding it might end both civilizations. Engineer Kenji Murakami races against an AI uprising and the heat death of the sun to make first contact the right way.',
        wordCount: 128000,
        pageCount: 482,
    ...
    },
    {
        ...
        description: 'Drawing on 200+ interviews with Fortune 500 executives and a decade of coaching data, Priya Anand reveals the seven counterintuitive principles that separate good managers from transformational leaders. Packed with frameworks, case studies, and actionable playbooks.',
        wordCount: 72000,
        pageCount: 288,
    ...
    },
    {
        ...
        description: 'Vienna, 1938. As the Third Reich tightens its grip on Austria, a Jewish art historian is recruited by British intelligence to smuggle a cache of stolen masterpieces—and the man who catalogued them—out of Nazi-occupied Europe.',
        wordCount: 108400,
        pageCount: 408,
    ...
    },
    {
        ...
        description: 'A woman wakes up in a hospital with no memory of the last six months—and a dead husband the police say she killed. As she pieces together the truth, she discovers some memories are better left buried.',
        wordCount: 86500,
        pageCount: 326,
    ...
    },
    {
        ...
        description: 'Six months after first contact, humanity\'s fragile alliance with the Aether Collective fractures—and Kenji Murakami finds himself the only human on an alien warship, racing to prevent an interstellar war.',
        wordCount: 142000,
        pageCount: 534,
        publicationDate: null,
        status: 'draft',
    ...
    },
    {
        ...
        description: 'A debut collection of 64 poems charting one year of grief after the loss of a child—raw, luminous, and ultimately transcendent.',
        wordCount: 18000,
        pageCount: 120,
    ...
    },
    {
        ...
        description: 'Priya Anand blends behavioral economics, mindfulness practice, and real-world financial planning into a radical new approach to building lasting wealth—starting from the inside out.',
        wordCount: 65000,
        pageCount: 258,
    ...
    },
    {
        ...
        description: 'A deaf code-breaker at the Somme discovers the Allied cipher has been compromised—by someone in his own unit. A race against dawn to expose the traitor before the morning advance.',
        wordCount: 96000,
        pageCount: 362,
    ...
    },
    {
        ...
        description: 'Twelve stories of broken futures and stubborn hope—from the last jazz club in a flooded New Orleans to an AI poet writing elegies in machine code.',
        wordCount: 52000,
        pageCount: 204,
...
exports.salesRecords = generateSales();
// ─── ARC Campaigns ────────────────────────────────────────────────────────────
exports.arcCampaigns = [
    {
        id: 'arc-001',
        titleId: 'title-001',
