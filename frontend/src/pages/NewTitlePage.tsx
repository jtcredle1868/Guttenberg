...
const inputStyle = (hasError: boolean): React.CSSProperties => ({
  ...
  border: hasError ? '1px solid rgba(248,113,113,0.55)' : '1px solid rgba(61,96,128,0.40)',
  outline: 'none',
...
export const NewTitlePage = () => {
  ...
  const getFocusStyle = (name: string, hasError: boolean): React.CSSProperties => ({
    ...inputStyle(hasError),
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{ background: 'radial-gradient(ellipse 60% 40% at 50% 0%, rgba(212,175,55,0.05) 0%, transparent 60%)' }}
          />
          ...
          <div className="relative z-10">
            <div className="mb-7">
              ...
              <p className="text-sm mt-1" style={{ color: 'rgba(138,175,200,0.65)' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  {...field('title')}
                  style={getFocusStyle('title', !!errors.title)}
                  placeholder="Enter your book title"
                  onFocus={() => setFocusedField('title')}
                  onBlur={() => setFocusedField(null)}
                />
                {errors.title && (
                  <p className="text-xs mt-1" style={{ color: '#f87171' }}>{errors.title}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  {...field('subtitle')}
                  style={getFocusStyle('subtitle', false)}
              ...
              <div>
                ...
                <input
                  {...field('authorName')}
                  style={getFocusStyle('authorName', !!errors.authorName)}
                  placeholder="Author or pen name"
                  onFocus={() => setFocusedField('authorName')}
                  onBlur={() => setFocusedField(null)}
                />
                {errors.authorName && (
                  <p className="text-xs mt-1" style={{ color: '#f87171' }}>{errors.authorName}</p>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    {...field('genre')}
                    style={getFocusStyle('genre', false)}
                ...
                <div>
                  ...
                  <select
                    {...field('language')}
                    style={getFocusStyle('language', false)}
